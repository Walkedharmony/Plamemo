...
# Dialog Frame
dialogFrame = tk.Frame(root)
dialogFrame.pack(side=tk.TOP)

nameFrame = tk.Frame(dialogFrame)
nameFrame.pack(side=tk.LEFT, fill=tk.X)

label_nama = tk.Label(nameFrame, text="<...>", font=("Helvetica", 24))
label_nama.pack(side=tk.LEFT)

label_posisi = tk.Label(root, text="0/0", font=("Helvetica", 21))
label_posisi.pack(side=tk.BOTTOM)

text = tk.Text(root, height = 3, font=("Seibi-Ai-B_Regular", 22))
